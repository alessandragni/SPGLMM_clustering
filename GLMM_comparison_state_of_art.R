...
# PLOT FOR THE SPGLMM_3

# set your working directory here
setwd("output/comparison_state_of_art/Poisson_SPGLMM_output")
...
melt %>%
  ...
  ggtitle("Coefficients for DGP through SPGLMM - 3 clusters") +
  xlab("") + ylab("")


ggsave(filename = 'plot_3_SPGLMM_coeff_POI.pdf',
       plot = last_plot(),
       device = NULL,
       scale = 1,
       width = 4.2,
...
# set your working directory here
setwd("output/comparison_state_of_art/Bernoulli_SPGLMM_output")
...
melt %>%
  ...
  ggtitle("Coefficients for DGP (i) through SPGLMM - 3 clusters") +
  xlab("") + ylab("")


ggsave(filename = 'plot_3_SPGLMM_coeff.pdf',
       plot = last_plot(),
       device = NULL,
       scale = 1,
       width = 4.2,
